...
// aqui nem é um problema em si, voce usa um modelo de 2 passes, enquanto faz o parsing ja vai gerando o bytecode
// não é ruim, mas gerar uma AST antes vai ser melhor, possibilita otimizações e vai gerar um bytecode mais organizado
// com mais contexto além de uma analise semantica superior
// percebi que em todo seu código existe muitos "else" e "else if", com o tempo voce vai diminuir essa ação pra algo mais otimizado
